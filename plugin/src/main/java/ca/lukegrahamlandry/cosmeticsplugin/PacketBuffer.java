...
public class PacketBuffer extends ByteBuf
{
    ...
    public byte[] readByteArray(int maxLength)
    {
        ...
        if (i > maxLength)
        {
            throw new ValueException("ByteArray with size " + i + " is bigger than allowed " + maxLength);
        }
        else
        {
    ...
    public int[] readVarIntArray(int maxLength)
    {
        ...
        if (i > maxLength)
        {
            throw new ValueException("VarIntArray with size " + i + " is bigger than allowed " + maxLength);
        }
        else
        {
            int[] aint = new int[i];
    ...
    public long[] readLongArray( long[] array, int maxLength)
    {
        ...
        if (array == null || array.length != i)
        {
            if (i > maxLength)
            {
                throw new ValueException("LongArray with size " + i + " is bigger than allowed " + maxLength);
            }
    ...
    public String readString(int maxLength)
    {
        ...
        if (i > maxLength * 4)
        {
            throw new ValueException("The received encoded string buffer length is longer than maximum allowed (" + i + " > " + maxLength * 4 + ")");
        }
        else if (i < 0)
        {
            throw new ValueException("The received encoded string buffer length is less than zero! Weird string!");
        }
        else
        {
            ...
            {
                throw new ValueException("The received string length is longer than maximum allowed (" + i + " > " + maxLength + ")");
            }
            else
            {
                return s;
    ...
    public PacketBuffer writeString(String string)
    {
        ...
        {
            throw new ValueException("String too big (was " + abyte.length + " bytes encoded, max " + 32767 + ")");
        }
        else
        {
